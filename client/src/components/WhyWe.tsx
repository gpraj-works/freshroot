    ...
    <Box my={45} bg="#d0fae5" bdrs={5} pb={0}>
      <Grid align="center" px={20}>
        ...
        <GridCol span={{ base: 12, lg: 8 }} p={20}>
          <Title order={1} mb={30} ta={{ base: 'center', lg: 'left' }} fz={{ base: 36, lg: 40 }}>
            Freshroot follow's
          </Title>
          <Grid gutter={40}>
            <GridCol span={{ base: 12, lg: 6 }}>
              <Flex gap={20}>
                <Box w={{ base: 225, lg: 160 }}>
                  <Image src={FastDeliveryIcon} width="100%" />
                </Box>
                <Stack gap={5}>
                  <Title order={3}>Fast Delivery</Title>
                  <Text>
            ...
            <GridCol span={{ base: 12, lg: 6 }}>
              <Flex gap={20}>
                <Box w={{ base: 180, lg: 160 }}>
                  <Image src={SafeParcelIcon} width="100%" />
                </Box>
                <Stack gap={5}>
                  <Title order={3}>Safe Parcel</Title>
            ...
            <GridCol span={{ base: 12, lg: 6 }}>
              <Flex gap={20}>
                ...
                <Stack gap={5}>
                  <Title order={3}>Doorstep Delivery</Title>
